(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),((e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports))((()=>{var e=[];async function t(){try{e=await(await fetch(`/events_2025/data.json`)).json(),n(e),document.getElementById(`search-input`).addEventListener(`input`,r),a()}catch(e){console.error(`Error loading data:`,e);let t=document.getElementById(`obituary-body`);t&&(t.innerHTML=`<tr><td colspan="8" class="loader">데이터를 불러오는 중 오류가 발생했습니다.</td></tr>`)}}function n(e){let t=document.getElementById(`obituary-body`);if(t){if(e.length===0){t.innerHTML=`<tr><td colspan="8" class="loader">검색 결과가 없습니다.</td></tr>`;return}t.innerHTML=e.map(e=>`
