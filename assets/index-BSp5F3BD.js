(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),((e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports))((()=>{var e=[];async function t(){try{e=await(await fetch(`/events_2025/data.json?v=${new Date().getTime()}`)).json(),n(e),l()}catch(e){console.error(`Error loading data:`,e)}}function n(e){let t=document.getElementById(`wedding-container`),n=document.getElementById(`obituary-container`),r=e.filter(e=>e.type===`wedding`),i=e.filter(e=>e.type===`obituary`),s=document.querySelector(`#wedding-section .section-title`),c=document.querySelector(`#obituary-section .section-title`);s&&(s.textContent=`✨ 경사 (결혼식) - 총 ${r.length}건`),c&&(c.textContent=`🕯️ 조사 (장례식) - 총 ${i.length}건`),a(r,t,`경사`),a(i,n,`조사`),o(e)}function r(e){if(!e||!e.relation)return 15e4;let t=e.relation.trim(),n=e.id;return t.includes(`친척`)?3e5:t.includes(`직장 동료`)||t.includes(`교회 지인`)||(t.includes(`학교선후배`)||t.includes(`동호회 지인`))&&n===20?2e5:15e4}function i(e){return e.toLocaleString()}function a(e,t,n){if(!t)return;if(e.length===0){t.innerHTML=`<p style="padding: 20px; color: #8B95A1;">데이터가 없습니다.</p>`;return}let a={},o=0;e.forEach(e=>{let t=(e.type===`wedding`?e.dateTime:e.diedDate).match(/(\d{4})[-년]\s*(\d{1,2})/),n=t?`${t[1]}년 ${parseInt(t[2])}월`:`기타`;a[n]||(a[n]=[]),a[n].push(e),o+=r(e)});let s=Object.keys(a).sort((e,t)=>{let n=e.match(/(\d+)년\s+(\d+)월/),r=t.match(/(\d+)년\s+(\d+)월/);return!n||!r?0:parseInt(n[1])*100+parseInt(n[2])-(parseInt(r[1])*100+parseInt(r[2]))}),c=`
        <table>
            <thead>
                <tr>
